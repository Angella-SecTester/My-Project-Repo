...
public class AjaxSpiderExample {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            // Retrieve results
            /*System.out.println("AJAX Spider scan completed. Results:");
            String results = api.ajaxSpider.results("0", "20").toString(2);
            int numberOfCrawledUrls = results.getItems().size();
