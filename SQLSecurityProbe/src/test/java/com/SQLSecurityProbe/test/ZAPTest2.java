...
public class ZAPTest2 {
    ...
    public void juiceShopSecurityTest() {
        ...
        if (firstDismissButton.isDisplayed()) {
        ...
        try {
            ...
            while (Integer.parseInt(((ApiResponseElement) api.spider.status("0")).getValue()) < 100) {
                Thread.sleep(2000);
            }
            ...
            for (ApiResponse scanner : scannerList.getItems()) {
                ...
                System.out.println("ScannerName :"+scannerName);
           ...
           /*// Perform the active scan
            int scanId = Integer.parseInt(((ApiResponseElement) api.ascan.scan("http://localhost:3000", "Default Context", null, null, null, null)).getValue());
            // Wait for the active scan to complete
            while (Integer.parseInt(((ApiResponseElement) api.ascan.status(String.valueOf(scanId))).getValue()) < 100) {
                Thread.sleep(2000);
            }*/
